...
Always wanted to try voice cloning. The base image wouldn't run, so I tracked down the missing pieces one by one. The result turned out useful enough to share.
